...
APP_SETTINGS: dict[str, str | int | float | bool | list[Any]] = {
    ...
    'confirm_on_window_delete': False,
    'dark_theme': 2,
    'date_format': '%x',
    'date_time_format': '%c',
    ...
    'notify_on_all_muc_messages': True,
    'notify_on_file_complete': True,
    'plugins_auto_update': False,
    'plugins_notify_after_update': False,
    ...
    'show_help_start_chat': False,
    'show_in_taskbar': True,
    'show_main_window_on_startup': 'last_state',
